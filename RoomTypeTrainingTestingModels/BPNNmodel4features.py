...
trainingCSV = '/Users/chizhang/2018Fall/cs542 Machine Learning/Project/MachineLearningProject/DataProcessing/EKO_4_features.csv'
trainingCSV_equ = '/Users/chizhang/2018Fall/cs542 Machine Learning/Project/MachineLearningProject/DataProcessing/EQUATION_4_features.csv'
...
x_trainDf = trainDf.iloc[:,1:5]
x_train = np.array(x_trainDf)
y_trainDf = trainDf.iloc[:,-1]
y_train = np.array(y_trainDf)

#read testing samples oxygen 186 samples
testingCSV = '/Users/chizhang/2018Fall/cs542 Machine Learning/Project/MachineLearningProject/DataProcessing/OXYGEN_4_features.csv'
testingDf = pd.read_csv(testingCSV)
x_testingDf = testingDf.iloc[:,1:5]
...
def BPNNmodel(x_train, y_train, activation_f, layers, hyper_paras, numFeatures):
    ...
    return modelNN
#test 4 features
#modelNN = BPNNmodel(norm_x_train, y_train, 'relu', 2, [30], 4)
...
# generate accuracy table save as a csv file
acc_table1 = tuningNNParameters(norm_x_train, y_train, norm_x_testing, y_testing, 1, 4)
...
acc_table2 = tuningNNParameters(norm_x_train, y_train, norm_x_testing, y_testing, 1, 4)
acc_table3 = tuningNNParameters(norm_x_train, y_train, norm_x_testing, y_testing, 1, 4)
acc_table4 = tuningNNParameters(norm_x_train, y_train, norm_x_testing, y_testing, 1, 4)
...
#save as a csv file
fileName = '/Users/chizhang/2018Fall/cs542 Machine Learning/Project/MachineLearningProject/BPNN_results_4features.csv'
acc_table.to_csv(fileName, index=False)
...
# =============================================================================
#use relu 3layers, h_para=10
modelNN = BPNNmodel(norm_x_train, y_train, 'relu', 3, [10], 4)
modelNN.save('4features BPNN Relu layer=3, h_para=10'+".h5")
# test accuracy on train set
...
plot_confusion_matrix(cnf_matrix, classes=class_names_str,
                      title='4 features BPNN Relu layer=3, h_para=10')
